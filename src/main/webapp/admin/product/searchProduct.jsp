...
<body>
<form method="post" action="${pageContext.request.contextPath }/product/multiConditionSearch" >
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr class="STYLE10" >
			...
			<td class="ta_01" bgcolor="#a8c7ce">
				<input type="text" name="pid" size="15" value="" id="Form1_userName" /></td>
			<td height="22" align="center" bgcolor="#a8c7ce"  >
				品牌：</td>
		...
		<tr class="STYLE10">
			...
			<td   bgcolor="#a8c7ce">
				<input type="text" name="pname" size="15" value="" id="Form1_userName" class="bg" /></td>
